...
import { TelevisionIcon, MagnifyingGlassIcon, SpinnerGapIcon, ArrowLeftIcon } from "@phosphor-icons/react/dist/ssr";

function TvSearchPageContent() {
  ...
  const performSearch = async (searchQuery: string) => {
    ...
    setError(null);
    try {
      const response = await tmdbService.searchTvShows(searchQuery);
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-7xl animate-in fade-in duration-500">
      <div className="text-center mb-12 space-y-4">
        <div className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl mb-4 shadow-lg">
          <TelevisionIcon size={40} weight="fill" className="text-white" />
        </div>
